        ...
        <div class="grid grid-cols-2 gap-4">
            <div>
                ...
                <div class="relative">
                    ...
                    <input
                        type="text" name="price" id="price" value="{{ old('price') }}" placeholder="15.000"
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <span class="absolute inset-y-0 right-0 flex items-center pr-4 text-gray-300 text-xs font-semibold select-none pointer-events-none">
                        pcs
                    </span>
                </div>
                @error('stock')
